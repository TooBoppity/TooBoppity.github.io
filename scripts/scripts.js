...
let duration = parseInt(document.getElementById("duration-text").value);
...
function recalculate() {
  ...
  if (modelName.value === "XYZ") {
    totalCost = duration * 100;
  } else if (modelName.value === "CPRG") {
